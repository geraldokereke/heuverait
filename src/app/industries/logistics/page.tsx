    ...
    <>
      ...
      <div className="relative min-h-[60vh] md:min-h-[70vh] flex items-center bg-gradient-to-br from-[#e0f2fe] via-[#bae6fd] to-[#e0f2fe] overflow-hidden">
        <SectionContainer className="z-10 w-full flex flex-col items-center justify-center text-center py-16 md:py-28">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-sky-900 mb-4 drop-shadow-lg">Logistics & Supply Chain Solutions</h1>
          <p className="text-lg md:text-2xl font-light text-sky-800 max-w-2xl mx-auto mb-6 md:mb-8">
            Digital platforms and analytics for faster, smarter, and more resilient logistics and supply chains.
          </p>
        </SectionContainer>
        <img src="/industries-logistics-hero.jpg" alt="Logistics" className="absolute right-0 bottom-0 w-1/3 max-w-xs md:max-w-md opacity-70 hidden md:block" />
      </div>

      {/* SECTION 1: Fleet & Route Optimization */}
      <SectionContainer className="py-10 md:py-16 border-b">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <img src="https://images.unsplash.com/photo-1519494080410-f9aa8f52f1e9?w=600&q=80" alt="Fleet Optimization" className="rounded-lg shadow-lg w-full max-h-72 object-cover order-2 md:order-1" />
      ...
      <SectionContainer className="py-14">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col">
            <h3 className="text-2xl font-semibold mb-2">Fleet Optimization Suite</h3>
            <img src="https://images.unsplash.com/photo-1465101178521-c1a9136a3fd9?w=400&q=80" alt="Fleet Suite" className="rounded-lg shadow mb-4 w-full h-40 object-cover" />
            <p className="text-sky-800 mb-4">
              Built a fleet management platform, reducing delivery times by 25% and lowering fuel costs.
            </p>
          </div>
          {/* Case Study 2 */}
          <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col">
            <h3 className="text-2xl font-semibold mb-2">Supply Chain Portal</h3>
            <img src="https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?w=400&q=80" alt="Supply Chain Portal" className="rounded-lg shadow mb-4 w-full h-40 object-cover" />
            <p className="text-sky-800 mb-4">
