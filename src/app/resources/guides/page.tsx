...
export default function GuidesResources() {
  ...
  const guides = [
    ...
    },
    {
      ...
      description: "Complete guide to creating and configuring your user account.",
      category: "getting-started",
      readTime: "8 min",
      difficulty: "Beginner",
    ...
    },
    {
      ...
      description: "Master the main dashboard and learn about all available features.",
      category: "getting-started",
      readTime: "10 min",
      difficulty: "Beginner",
    ...
    },
    {
      ...
      description: "Step-by-step guide to creating your first project from scratch.",
      category: "getting-started",
      readTime: "15 min",
      difficulty: "Beginner",
    ...
    },
    {
      ...
      description: "Secure your API integrations with proper authentication methods.",
      category: "advanced",
      readTime: "20 min",
      difficulty: "Advanced",
    ...
    },
    {
      ...
      description: "Build complex automated workflows to streamline your processes.",
      category: "advanced",
      readTime: "25 min",
      difficulty: "Advanced",
    ...
    },
    {
      ...
      description: "Advanced techniques to optimize performance and reduce load times.",
      category: "advanced",
      readTime: "30 min",
      difficulty: "Advanced",
    ...
    },
    {
      ...
      readTime: "10 min",
      difficulty: "Beginner",
      image: "https://images.unsplash.com/photo-1581287053822-fd7bf4f4bfec?w=400&q=80",
