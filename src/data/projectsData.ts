...
export const projectsData: Project[] = [
  ...
  {
  slug: "newomcii",
  name: "New Dawn for Women & Community Intervention Initiative (NEWOMCII)",
  type: "NGO Website + Community Empowerment Platform",
  description: "A modern multi-page web platform built to enhance NEWOMCII’s digital presence, empower women, support community development programs, and create stronger public engagement.",
  ...
  details: "Developed a fully responsive, modern website that supports content management, program documentation, volunteer sign-up, and awareness-based outreach. Integrated accessibility-focused UI and long-term maintainability features.",
  technologies: ["Next.js", "TypeScript", "TailwindCSS", "Framer Motion", "TinaCMS (Local)", "Cloudinary"],
  tag: "Web",
  links: [],
  quote: "NEWOMCII is committed to empowering women and transforming communities through sustainable development and inclusion.",
  quoteCite: "Founder, NEWOMCII",
  challenges: "Needed a scalable website capable of communicating programs, managing content without code, and enabling staff to update information independently.",
  challengesImage: "https://images.unsplash.com/photo-1551434678-e076c223a692?w=600&h=400&fit=crop",
  solutions: "Implemented a custom content management system using TinaCMS in local mode, enabling program updates, team profiles, and event documentation without requiring developer involvement.",
  solutionsImage: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&h=400&fit=crop",
  userFlow: "Visitors easily navigate through Programs, About Us, Media Center, and Get Involved pages, enabling volunteering, partnership, and donation engagement.",
  userFlowImage: "https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=600&h=300&fit=crop",
  wireFraming: "Designed page layouts to prioritize clarity, trust-building visuals, and storytelling through program highlights and impact metrics.",
  wireFramingImage: "https://images.unsplash.com/photo-1581291518857-4e27b48ff24e?w=600&h=400&fit=crop",
  storyMapping: "Focused on guiding users from awareness → understanding → engagement, with clear CTAs to volunteer, join programs, or contact the organization.",
  storyMappingImage: "https://images.unsplash.com/photo-1552664730-d307ca884978?w=600&h=300&fit=crop",
  development: "Built the front-end using Next.js with server-rendered pages, structured content fields, and animated hero sections powered by Framer Motion.",
  developmentImage: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=600&h=300&fit=crop",
  architecture: "Next.js front-end + Local Git-based CMS (TinaCMS) + Cloudinary for media assets.",
  architectureImage: "https://images.unsplash.com/photo-1605902711622-cfb43c4437b5?w=600&h=400&fit=crop",
  testing: "Tested UI responsiveness, content editing workflow, accessibility, and page load optimizations.",
  testingImage: "https://images.unsplash.com/photo-1581091870627-3b4f5b5972d8?w=600&h=400&fit=crop",
  deployment: "Deployed as a production web app with clean routing, fast asset delivery, and ongoing maintainability support.",
  deploymentImage: "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=600&h=400&fit=crop"
}
];