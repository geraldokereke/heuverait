...
export default function Button({
    ...
    const baseClasses = type === 'default'
        ? 'inline-flex items-center px-4 lg:px-3 xl:px-4 2xl:px-6 py-2 lg:py-1 xl:py-2 2xl:py-3 rounded-full font-poppins font-medium transition-colors text-[10px] md:text-base lg:text-xs xl:text-sm 2xl:text-base'
