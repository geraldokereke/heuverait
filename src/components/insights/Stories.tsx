      ...
      <section className="relative py-20">
        ...
        <SectionContainer>
          <div className="z-10 flex justify-between items-end mb-0 2xl:mb-12">
            ...
            />
            <button className="group text-xs 2xl:text-base text-white font-semibold flex items-center hover:text-black transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 z-10">
            {caseStudies.map((study, index) => (
              <div key={index} className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300">
                <div className="relative h-52 2xl:h-64">
                  <Image
                    src={study.image}
                    alt={study.title}
                    fill
                ...
                <div className="p-6 2xl:p-8">
                  <div className="flex justify-between items-center mb-2 2xl:mb-4">
                    <span className="px-3 py-1 bg-[#41a7ad]/10 text-[#41a7ad] text-[10px] 2xl:text-sm font-semibold rounded-full">
                      {study.industry}
                    </span>
                  ...
                  <h3 className="text-base 2xl:text-2xl font-bold text-gray-900 mb-1.5 2xl:mb-3">
                    {study.title}
                  </h3>
                  <p className="text-xs 2xl:text-base text-gray-600 mb-6">
                    {study.description}
                  </p>
                  <button className="text-xs 2xl:text-base group text-[#41a7ad97] font-semibold flex items-center hover:text-[#41a7ad] transition-colors duration-300">
                    Read Case Study
                  </button>
                </div>
              </div>
