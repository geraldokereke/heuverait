                ...
                <SectionContainer className="w-full">
                    <div className="max-w-4xl text-center lg:text-start">
                        ...
                        >
                            ...
                            <span className="text-[#41a7ad] font-medium">cutting-edge solutions</span>{" "}
                            for global organisations and technology startups. Since 2024 we have been helping companies and established brands{" "}
                            <span className="text-[#41a7ad] font-medium">reimagine their business</span>{" "}
